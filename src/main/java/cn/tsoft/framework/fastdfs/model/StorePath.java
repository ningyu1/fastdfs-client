...
import cn.tsoft.framework.fastdfs.exception.FastDfsUnsupportStorePathException;
 ...
 * 存储文件的路径信息
 * @author ningyu
 * @date 2017年5月17日 下午4:44:27
 */
public class StorePath implements Serializable {
    /**
     */
    private static final long serialVersionUID = 432485143733614912L;
